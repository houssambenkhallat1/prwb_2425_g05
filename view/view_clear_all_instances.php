...
<head>
    ...
    <title>Delete instances confirmation box</title>
</head>
<body>
<div class="cancellation-box">
    <div class="row-cols-lg-1">
        ...
        <div class="p">
            ...
            <a href="form/manage/<?= $form->get_id() ?>" class="btn btn-secondary mb-2 w-100">Cancel</a>
            <form method="POST" action="instance/delete_all">
