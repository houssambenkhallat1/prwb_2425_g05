...
<head>
    ...
    <title>Read instance</title>
</head>
<body>
<div class="position-relative">
    <header class="form-container d-flex justify-content-between p-2 text-white">
        <!-- confirmation link -->
        <a href="form"><span class="light-blue mt-1"><i class="bi bi-arrow-left"></i></span></a>
        ...
        <div id="btn-header-container" class="d-flex justify-content-end">
            ...
            <?php if($question->has_previous_question_idx()): ?>
                <a class="btn btn-dark"
                   href="instance/read/<?= $instance->get_id() ?>/<?= $question->get_idx() - 1?>">
        ...
        <div class="mt-4">
            ...
            <div>
                <div class="form-group">
                    ...
                    <input disabled class="form-control" id="answer" value="<?= $answer->get_value() ?>">
                </div>
            </div>
        </div>
    </main>
