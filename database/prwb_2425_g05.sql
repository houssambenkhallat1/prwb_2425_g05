drop database if exists `prwb_2425_g05`;
CREATE
DATABASE IF NOT EXISTS `prwb_2425_g05`;
USE
`prwb_2425_g05`;
...
CREATE TABLE form_colors
(
    form        INT                                     NOT NULL,
    color       enum('blue', 'red', 'green', 'yellow')  NOT NULL,
    primary key (form, color),
